 ...
 * `data.cdb` with tinydns-data. Both djbdns daemons read that cdb: tinydns
 * answers UDP queries from it, axfrdns serves TCP and zone transfers.
 *
 * Unlike the zone-file publishers, djbdns has one global data file covering
